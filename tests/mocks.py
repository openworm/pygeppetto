from pygeppetto.model import GeppettoModel, GeppettoLibrary, CompositeType, Variable, TimeSeries
...
class MockModelInterpreter:
    ...
    def __init__(self):
        self.factory = GeppettoModelFactory(GeppettoModelFactory.create_geppetto_model('test'))
